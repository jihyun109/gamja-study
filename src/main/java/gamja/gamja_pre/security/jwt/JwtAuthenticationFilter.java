...
// 토큰 검증, 인증 정보를 자동으로 설정(사용자 인증), 인증된 사용자 정보를 SecurityContext에 설정
@Component
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        return request.getServletPath().equals("/login")|| request.getServletPath().equals("/users/signup") || request.getServletPath().equals("/users/paged") ;
    }
}
